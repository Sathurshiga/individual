...
public class Usr {
	...
	public String readItems()
	{
		String output = "";
		  ...
		  {	
			  ...
			  output = "<table border='1'><tr><th>nID</th><th>nic</th>" +
					  "<th>tele</th>" +
					  "<th>address</th>"+
					  "<th>meterNo</th>";
	...
	public String updateItem(String nID, String code, String name, String price, String desc)
	{
		String output = "";
		  try
		  {
			  ...
			  if (con == null)
		  {
			  ...
			  // binding values
				...
				preparedStmt.setInt(5, Integer.parseInt(nID));
